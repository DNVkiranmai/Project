...
option = [0,'Welcome to Hangman!!','Play New Game','About','Quit',0,'',0]# menu options
...
infoDisplayText = ['Welcome to Hangman','','','','','']# [0-5 Text, 2 per row]
...
def infoDisplay(who,time):
    ...
    text = basicFont.render(infoDisplayText[0] + infoDisplayText[1], True,maroon ,WHITE)
    text1 = basicFont.render(infoDisplayText[2] + infoDisplayText[3], True, maroon,WHITE)
    text2 = basicFont.render(infoDisplayText[4] + infoDisplayText[5], True,maroon ,WHITE)
    while count < time:
        if who[2] == who[12]:
            count+=1
        if who[2]< who[12]:
...
def gallows():
    ...
    pygame.draw.rect(windowSurface, gold1,(401, 71, 28, 288))
    pygame.draw.rect(windowSurface, gold1,(121, 41, 338, 28))
    pygame.draw.rect(windowSurface, gold1,(101, 361, 398, 28))
    pygame.draw.rect(windowSurface, gold1,(461, 391, 28, 78))
    pygame.draw.polygon(windowSurface, gold1,((1,469),(1,451),(26,451),(26,431),(51,431),(51,411),(76,411),(76,391),(129,391),(129,469)))
    pygame.draw.polygon(windowSurface, gold1,((399,302),(342,359),(369,359),(400,329)))
    pygame.draw.polygon(windowSurface, gold1,((430,301),(489,359),(461,359),(430,329)))
    pygame.draw.polygon(windowSurface, gold1,((399,128),(341,70),(369,70),(399,100)))
...
def displayBoard(display,missedLetters, correctLetters, secretWord):
    ...
    title = titleFont.render('Hangman', True,maroon ,)
    
    
    category = basicFont.render(secretKey + ' - ' + str(len(secretWord)) + ' letters', True, crimson,)
...
def menu():
    ...
    while option[5]==0:# Option [5] is the selection output bit
        ...
        if curser[1]==190:
            curser[2]=290
            option[6]='Are You Ready to play the "Hangman" Game????'
        if curser[1]==240:
            curser[2]=260
        ...
        text1 = guessFont.render(option[1], True,crimson ,)
        
        text2 = guessFont.render(option[2], True, crimson,)
        
        text3 = guessFont.render(option[3], True,crimson ,)
        
        text4 = guessFont.render(option[4], True, crimson,)
       
        text5 = basicFont.render(option[6], True, gold1,)
        text6s = bannerFont.render("Hangman",True, BLACK,)
        text6 = bannerFont.render("Hangman",True, firebrick4,)
...
def drawBanner():
    pygame.draw.line(windowSurface,cyan2,(0,70),(800,70),50)
...
def about():
    while option[7]>=0:
        ...
        text1 = guessFont.render('Hangman is our Project. It was written by ', True, crimson,)
        
        text2 = guessFont.render('D.N.V.Kiranmai, K.Sanjana, P.Swetha in 2018.Our mentor is', True, crimson,)
        
        text3 = guessFont.render('G.Madhavi.It is written in Python 3.6 and Pygame 1.9.', True, crimson,)
        
        text4 = guessFont.render('The Hangman Logic from Al Sweigarts brilliant book', True, crimson,)
        
        text5 = guessFont.render('\'Invent Your Own Computer Games with Python\'', True, crimson,)
        
        text6 = bannerFont.render("Hangman",True, maroon,)
...
infoDisplayText = ['Well done!','','You have reached round ',str(roundNo+1),'Next Subject - ',secretKey]
while True:
...
##                    noooSound.play()
                    ...
                    if roundNo>8:
                        ...
                        score[3]+=1
                        playerWinSound.play()
                        infoDisplayText = ['Congratulationd!','','You guessed 9 words','','and beat the Hangman','']
